...
def main():
    ...
    if args.output:
        fh = codecs.open(args.output, "ab", "utf8")
    else:
        fh = sys.stdout
    ...
    if args.since_id:
        ...
        since_id = redis_conn.get(SINCE_ID_KEY)
    ...
    while True:
        ...
        for thing in things:
            ...
            if line_count:
                n = 4.907  # wait at least 2 ** 4.907 = 30s
